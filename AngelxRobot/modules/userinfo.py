...
from AngelxRobot.__main__ import STATS, TOKEN, USER_INFO
import AngelxRobot.modules.sql.userinfo_sql as sql
from AngelxRobot.modules.disable import DisableAbleCommandHandler
from AngelxRobot.modules.sql.global_bans_sql import is_user_gbanned
from AngelxRobot.modules.sql.afk_sql import is_afk, check_afk_status
from AngelxRobot.modules.sql.users_sql import get_user_num_chats
from AngelxRobot.modules.helper_funcs.chat_status import sudo_plus
from AngelxRobot.modules.helper_funcs.extraction import extract_user
from AngelxRobot import telethn as FallenTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/comrade_network/96962">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
